...
const getIcon = (techName) => {
  ...
  return techs[techName]?.icon;
}

const projectsData = (() => {
  const projects = []

  const addProjects = (screenshot, title, summary, features, techs, demo, repos) => {
    const projectsObj = {
...
const projectsList = () => {
  ...
  projectsData.addProjects(
    ...
    ['1. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perspiciatis, quas!', '2. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perspiciatis, quas!'], 
